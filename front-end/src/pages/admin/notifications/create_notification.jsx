...
export default function AdminCreatenNotificationPage() {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    axios
      .post(`${appSettings.API_PROXY}/notifications`, formData)
      .then(() => {
    ...
    <AdminLayout>
      <Container maxW="6xl" py={8}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <FormControl id="description" isRequired mt={2} flex={3} mr={16}>
