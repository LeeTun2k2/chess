            ...
            >
              <Thead bgColor={theme === "dark" ? "black" : "gray.200"}>
                <Tr>
                  ...
                  <Th width="12%" textAlign={"center"} cursor={"pointer"}>
                    {t("common.variant")}
                  </Th>
                ...
                {renderData
                  ...
                  .map((item, index) => (
                    ...
                    >
                      ...
                      <Td>
                        <Text textAlign={"left"} noOfLines={3}>
                          {item.name}
                        </Text>
                      </Td>
                      <Td>
                      ...
                      <Td textAlign={"center"}>{formatDatetime(item.start)}</Td>
                      <Td textAlign={"center"}>{formatDatetime(item.end)}</Td>
                    </Tr>
                  ))}
              </Tbody>
              <Tfoot>
