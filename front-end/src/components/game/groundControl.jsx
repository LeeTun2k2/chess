...
import { RepeatIcon, ArrowBackIcon, ChevronLeftIcon, ChevronRightIcon, ArrowForwardIcon } from "@chakra-ui/icons"
...
export default function GroundControl()
{
    ...
    return (
        <Grid templateColumns="repeat(5, 3rem)" justifyContent="center">
            <GridItem 
                onClick={flip} 
                cursor="pointer" 
                bgColor="#bababa" 
