...
export default function AjaxRequestHttpResponseCodeHostnameReport({ theme }) {
  ...
  const renderColumnChart = (dataset, title) => {
    ...
    const chartData = [
      [t("dashboard.httpResponseCode"), t("dashboard.count")],
  ...
  return (
    ...
    >
      ...
      >
        ...
        {t("dashboard.ajax_request_http_response_code_hostname")}
      </Heading>
      <Flex>
        <Flex w={"50%"} h={"100%"}>
          {renderColumnChart(
